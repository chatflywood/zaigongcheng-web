    ...
    <div v-else class="page">
      ...
      <header class="page-head">
        <div class="page-head-l">
          ...
          <h1 class="page-title">在建工程进度看板</h1>
          <div class="page-meta">
      ...
      <div class="section" style="margin-bottom:48px">
        <div class="kpi-grid">
          <div class="kpi" v-for="(k, i) in metrics" :key="i">
            ...
            <div class="kpi-value"><span class="mono">{{ animatedValues[i] || k.value }}</span><span v-if="k.unit" style="font-size:13px;color:var(--ink-3);font-weight:400;margin-left:4px">{{ k.unit }}</span></div>
            <div class="kpi-foot">
